export function createWorkspaceSnapshot(state) {
  return {
    ...
    pickerSelectedClauseIdsBySpec: state.ui.pickerSelectedClauseIdsBySpec || {},
...
export function normalizeWorkspacePayload(payload, dependencies) {
  return {
    ...
    pickerSelectedClauseIdsBySpec:
      dependencies.normalizePickerSelectedClauseIdsBySpec?.(payload?.pickerSelectedClauseIdsBySpec) || {},
